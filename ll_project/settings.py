...
SECRET_KEY = config('SECRET_KEY', default='your-current-secret-key-here')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='ll_project_db'),
        'USER': config('DATABASE_USER', default='minaee'),
